        ...
        <div className="flex space-y-6">
            ...
            <main className="flex-1 p-10 mt-5">
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-around mb-8 space-y-4 md:space-y-0 md:space-x-4">
                        <div className="relative w-full md:w-1/2">
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 rounded-full bg-white text-black placeholder-black-400 border border-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            />
                        ...
                        <div className="w-full md:w-auto">
                            <select
                                ...
                                className="w-full md:w-auto rounded-full bg-white text-black border border-slate-700 py-2 px-4 focus:outline-none focus:ring-2 focus:ring-sky-500"
                            >
                    ...
                    {!loading && !error && (
                        <div className="grid  md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-6 justify-between">
                            {cryptos.length > 0 ? (
                                cryptos.map(crypto => (
                                    <div
                                        key={crypto.id}
                                        className="bg-white rounded-xl p-6 shadow-md cursor-pointer border border-gray-100 transition-all duration-300 hover:shadow-xl hover:border-blue-100 hover:-translate-y-1"
                                        
                                    >
                                        <div className="flex items-center space-x-4 mb-4">
                                            <img src={crypto.image} alt={crypto.name} className="h-10 w-10 shadow-sm" onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/40x40/252f40/8e9ba9?text=C"; }} />
                                            <div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-black font-medium">{formatPrice(crypto.current_price, currency)}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
